...
// console.log();
  ...
  // let selDirID=sessionStorage.getItem("rootFolder");
...
const handleSubmit=(e)=>{
  ...
  fetch(addUrl,{
    ...
    if((result.status===true) && (result.DocumentID!="-1") && (result.DocumentID!="null")){
      Swal.fire({
        icon:"success",
    ...
    }else if(result.status===true && result.DocumentID==="-1"){
