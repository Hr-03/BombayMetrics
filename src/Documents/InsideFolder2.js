...
let directId=sessionStorage.getItem("insideFolder");
...
<Sidebar/>
    ...
    <Row className='m-4'>
      <Col>
      <Card className='p-3'>
        <p className='docTitle mb-4'>Your Documents > {dirName} > {dirName1}</p>
        <Row>
          <Col>
          <Row>
<Col md={8}>
       ...
       {!toggleView && <Row className='mt-4'>
          ...
          <Card className='foldCrd p-3 border-0 m-2' onClick={()=>{
            sessionStorage.setItem("insideFolder1",dir?.DirectoryID)
            sessionStorage.setItem("lvl2Name",dir?.DirectoryName)
  ...
  toggleView && directories?.map((drc,i)=>{
    return(
      ...
      <Card className='foldCrd p-3 pt-0 border-0 m-2' onClick={()=>{
            ...
            sessionStorage.setItem("lvl2Name",drc?.DirectoryName)
