...
function InsideFolder4() {
    const navigate=useNavigate();
    let dirName=sessionStorage.getItem("rootfName");
    let dirName1=sessionStorage.getItem("lvl1Name");
    let dirName2=sessionStorage.getItem("lvl2Name");
    let dirName3=sessionStorage.getItem("lvl3Name");
...
let directId=sessionStorage.getItem("insideFolder2");

    const url=`https://www.orthosquareportal.com/BMAPI/BombayMetricsService.svc/GetDirectory/${directId}/${empID}`;
...
<Sidebar/>
    ...
    <Row className='m-4'>
      <Col>
      <Card className='p-3'>
        <p className='docTitle mb-4'>Your Documents > {dirName} > {dirName1} > {dirName2} > {dirName3}</p>
        <Row>
          <Col>
          <Row>
<Col md={8}>
       ...
       {!toggleView && <Row className='mt-4'>
          ...
          <Card className='foldCrd p-3 border-0 m-2' onClick={()=>{
            sessionStorage.setItem("insideFolder3",dir?.DirectoryID)
            sessionStorage.setItem("lvl4Name",dir?.DirectoryName)
                ...
                <Dropdown>
                      ...
                      {doc?.sharedDocument==="0"?  <Dropdown.Item href="" className='p-2' onClick={()=>{
                        ...
                        {doc?.sharedDocument==="0"? <Dropdown.Item href="" className='p-2' onClick={()=>{
                          ...
                          handleDocDelShow()
                        }}>Delete</Dropdown.Item>:""}<Dropdown.Divider/>
...
<Dropdown.Divider/>
              ...
              {/* <p className='mt-3 foldContent'>2 Folders, 2 Files</p> */}
              </Col>
            </Row>
          </Card>
  ...
  toggleView && directories?.map((drc,i)=>{
    return(
      ...
      <Card className='foldCrd p-3 pt-0 border-0 m-2' onClick={()=>{
            ...
            sessionStorage.setItem("lvl4Name",drc?.DirectoryName)
