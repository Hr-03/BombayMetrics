...
let directId=sessionStorage.getItem("insideFolder1");
...
<Sidebar/>
    ...
    <Row className='m-4'>
      <Col>
      <Card className='p-3'>
        <p className='docTitle mb-4'>Your Documents > {dirName} > {dirName1} > {dirName2}</p>
        <Row>
          <Col>
          <Row>
<Col md={8}>
        ...
        {!toggleView && <Row className='mt-4'>
          ...
          <Card className='foldCrd p-3 border-0 m-2' onClick={()=>{
            sessionStorage.setItem("insideFolder2",dir?.DirectoryID)
            sessionStorage.setItem("lvl3Name",dir?.DirectoryName)
  ...
  toggleView && directories?.map((drc,i)=>{
    return(
      ...
      <Card className='foldCrd p-3 pt-0 border-0 m-2' onClick={()=>{
            ...
            sessionStorage.setItem("lvl3Name",drc?.DirectoryName)
