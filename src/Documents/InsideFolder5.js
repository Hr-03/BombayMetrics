...
function InsideFolder5() {
    ...
    let dirName4=sessionStorage.getItem("lvl4Name");
...
let directId=sessionStorage.getItem("insideFolder3");
...
<Sidebar/>
    ...
    <Row className='m-4'>
      <Col>
      <Card className='p-3'>
        <p className='docTitle mb-4'>Your Documents > {dirName} > {dirName1} > {dirName2} > {dirName3}c > {dirName4}</p>
        <Row>
          <Col>
          <Row>
<Col md={8}>
